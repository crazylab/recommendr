...
//    val freqMap : RDD[(String, Int)] = sc.emptyRDD[(String, Int)]
//    val (addedTransactionCount: Long, freqMapInc: RDD[(String, Int)], reducedList: RDD[((String, String), Long)]) = incrementalStepPairCount(data)
...
//  }
//
//  def incrementalStepPairCount(data: RDD[String]): (Long, RDD[(String, Int)], RDD[((String, String), Long)]) = {
...
//    val rdd = sc.textFile("/Users/dileepba/tmp/tags1.txt",8)
